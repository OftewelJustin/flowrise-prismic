...
const components: JSXMapSerializer = {
    ...
    paragraph: ({children}) => (
        <p className="text-2xl font-normal font-body leading-10 text-slate-600 mb-4 md:mb-8 max-w-md">
            {children}
        </p>
    ),
}
          ...
          {slice.variation === "default" && (
              <Bounded data-slice-type={slice.slice_type} data-slice-variation={slice.variation}>
                  <div className="grid grid-cols-1 place-items-center text-center">
                      ...
                      <Button field={slice.primary.button_link} className="mb-8 md:10">
      ...
      {slice.variation === "horizontal" && (
        <Bounded data-slice-type={slice.slice_type} data-slice-variation={slice.variation}>
            <div className="grid grid-cols-1 md:grid-cols-2 place-items-center">
                <div className="grid grid-rows-[1fr,auto,auto] gap-4 h-fit">
                    <PrismicRichText field={slice.primary.heading} components={components} />
                    <PrismicRichText field={slice.primary.body} components={components}/>
                    <Button field={slice.primary.button_link} className="mb-8 md:10">
                        {slice.primary.button_text}
