...
const Features = ({ slice }: FeaturesProps): JSX.Element => {
  return (
    ...
    >
      ...
      <div className="grid sm:grid-cols-3 lg:grid-cols-4 max-w-5xl gap-x-8 gap-y-12 mx-auto sm:place-items-start place-items-center">
  ...
  return (
      <svg xmlns="http://www.w3.org/2000/svg" width="72" height="71" fill="none">
        <path
            stroke="#0891B2"
            strokeWidth="4.99"
            d="M2.67 35c0-12.57 0-18.86 3.9-22.76 3.9-3.9 10.2-3.9 22.76-3.9h13.34c12.57 0 18.85 0 22.76 3.9 3.9 3.9 3.9 10.19 3.9 22.76v6.67c0 12.57 0 18.85-3.9 22.76-3.9 3.9-10.2 3.9-22.76 3.9H29.33c-12.57 0-18.85 0-22.76-3.9-3.9-3.9-3.9-10.2-3.9-22.76V35z"
        ></path>
        <path
            stroke="#0891B2"
            strokeLinecap="round"
        ...
        <path
            fill="#0891B2"
            d="M56 51.67a3.33 3.33 0 11-6.67 0 3.33 3.33 0 016.67 0zm0-13.34a3.33 3.33 0 11-6.67 0 3.33 3.33 0 016.67 0zM39.33 51.67a3.33 3.33 0 11-6.66 0 3.33 3.33 0 016.66 0zm0-13.34a3.33 3.33 0 11-6.66 0 3.33 3.33 0 016.66 0zM22.67 51.67a3.33 3.33 0 11-6.67 0 3.33 3.33 0 016.67 0zm0-13.34a3.33 3.33 0 11-6.67 0 3.33 3.33 0 016.67 0z"
        ></path>
      </svg>
  );
}
